...
function SidebarRail({ className }: { className?: string }) {
  ...
  return (
    <div
      ...
      className={cn(
        "absolute inset-y-0 z-20 hidden w-1.5 group-data-[side=left]:-right-[3px] after:absolute after:inset-y-0 after:left-1/2 after:w-px after:-translate-x-1/2 after:bg-transparent after:transition-colors hover:after:bg-sidebar-border sm:flex",
        open ? "cursor-pointer" : "cursor-pointer",
        className
      )}
    />
  )
